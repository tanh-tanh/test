...
import type { Clue, PuzzleData } from '@/lib/puzzle';
...
export default function CrissCrossPuzzle({ puzzleData }: { puzzleData: PuzzleData }) {
  const { gridSize, clues, solutionGrid, id: puzzleId } = puzzleData;
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div className="space-y-6">
        <div>
          <h3 className="font-bold text-xl text-primary mb-2">Ngang</h3>
        ...
        <div>
          <h3 className="font-bold text-xl text-primary mb-2">Dọc</h3>
          <ul className="space-y-1">
      ...
      <LuckyWheel open={isWheelOpen} onOpenChange={setWheelOpen} />
    </div>
  );
}
